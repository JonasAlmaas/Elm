...
namespace elm {
	...
	void renderer_2d::flush(void)
	{
		...
		s_data.texture_blank->bind(); // Temp

		s_data.shader->set_float("u_texture_tiling_factor", 0.0f);
		...
		const glm::vec4 &color)
	{
		...
		s_data.quad_vertex_buf_ptr->uv = { 0.0f, 0.0f };
		s_data.quad_vertex_buf_ptr->color = color;
		++s_data.quad_vertex_buf_ptr;

		s_data.quad_vertex_buf_ptr->position = transform * glm::vec4(0.5f, -0.5f, 0.0f, 1.0f);
		s_data.quad_vertex_buf_ptr->uv = { 1.0f, 0.0f };
		s_data.quad_vertex_buf_ptr->color = color;
		++s_data.quad_vertex_buf_ptr;

		s_data.quad_vertex_buf_ptr->position = transform * glm::vec4(0.5f, 0.5f, 0.0f, 1.0f);
		s_data.quad_vertex_buf_ptr->uv = { 1.0f, 1.0f };
		s_data.quad_vertex_buf_ptr->color = color;
		++s_data.quad_vertex_buf_ptr;

		s_data.quad_vertex_buf_ptr->position = transform * glm::vec4(-0.5f, 0.5f, 0.0f, 1.0f);
		s_data.quad_vertex_buf_ptr->uv = { 0.0f, 1.0f };
		s_data.quad_vertex_buf_ptr->color = color;
		++s_data.quad_vertex_buf_ptr;
		...
		s_data.shader->set_float4("u_color", color); // Replace with vertex color
